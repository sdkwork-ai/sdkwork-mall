# Runbook — sdkwork-mall deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-mall-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-mall/bundle`, loads the image, starts
